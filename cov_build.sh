...
############################
# Build entservices-hdcpprofile
echo "======================================================================================"
echo "buliding entservices-hdcpprofile"

cd ${GITHUB_WORKSPACE}
cmake -G Ninja -S "$GITHUB_WORKSPACE" -B build/entservices-hdcpprofile \
-DUSE_THUNDER_R4=ON \
...
cmake --build build/entservices-hdcpprofile --target install
echo "======================================================================================"
exit 0
